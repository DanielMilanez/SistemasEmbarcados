...
/* Private defines -----------------------------------------------------------*/
#define PRESENCE_SENSOR_Pin GPIO_PIN_6
#define PRESENCE_SENSOR_GPIO_Port GPIOA
#define SW_ENCODER_Pin GPIO_PIN_7
#define SW_ENCODER_GPIO_Port GPIOA
...
#define LD10_Pin GPIO_PIN_3
#define LD10_GPIO_Port GPIOB
#define LD8_Pin GPIO_PIN_4
#define LD8_GPIO_Port GPIOB
#define LD9_Pin GPIO_PIN_5
