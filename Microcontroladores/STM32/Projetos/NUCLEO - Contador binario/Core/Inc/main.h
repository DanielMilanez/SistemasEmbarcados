...
#define PORT_E_Pin GPIO_PIN_7
#define PORT_E_GPIO_Port GPIOA
#define PORT_G_Pin GPIO_PIN_7
#define PORT_G_GPIO_Port GPIOC
#define PORT_H_Pin GPIO_PIN_9
#define PORT_H_GPIO_Port GPIOA
#define PORT_F_Pin GPIO_PIN_6
