...
//  counterFiltred = (rawCounter / 2) % 181; // Limite 0 - 180
//}
//
//void Check_rotate(void){
//	duty_servo = (((counterFiltred * 11.11) / 1) + 500);
//	HAL_Delay(20);
//	TIM21 -> CCR1 = duty_servo;
//
//	if (duty_servo >= 2500) duty_servo = 2500;
//	if (duty_servo <= 500)  duty_servo = 500;
//}
