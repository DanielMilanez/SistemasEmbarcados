...
#define CONST2PI 3.141593 * 2
#define RESULUTION 0xFFF // 12bits
/* USER CODE END PD */
...
//	else modulate--;
//
//	if (modulate >= 155) flag = 1;
//	else if (modulate <= 75) flag = 0;
//}
/* USER CODE END 0 */
...
// Onda trangular
//  for (int i = 0; i < SIZE; ++i) SINE[i] = i * FI + OFFSET;
